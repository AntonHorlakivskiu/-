...
class CollisionSensor(object):
    def __init__(self, parent_actor, hud):
        ...
        self.sensor.(lambda event: CollisionSensor._on_collision(weak_self, event))
...
class LaneInvasionSensor(object):
    def __init__(self, parent_actor, hud):
        ...
        # reference.
        weak_self = weakref.ref(self)
        self.sensor.(lambda event: LaneInvasionSensor._on_invasion(weak_self, event))
...
#********************************
            # note that +x is to the left of the car, +y is to the back of the car, +z is to the ground (downwards).
